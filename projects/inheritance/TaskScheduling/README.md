...
本部分实验将不再要求完全手写代码，而是引入 AI 编程助手辅助编写代码。实验重点不在代码量，而在于你如何描述需求、如何验证 AI 生成代码，以及如何修正其中的逻辑问题。
...
需自行编写需求描述给 AI，在描述过程中，应主动考虑一些潜在问题，例如输入字符串中可能存在空格、输入格式可能不合法、任务结构可能出现多层嵌套等情况。
